...
export default function PopUpEditMidia({ setShowPopUpEdit, Midia }) {

    const [ title, setTitle ] = useState(Midia.toString())
            ...
            <Popup open={true} onClose={closeModal} modal nested>
                <div className="w-96 h-96 bg-white rounded-lg shadow-md shadow-dark-blue">
                    ...
                    <div className="justify-center text-center">
                        <h2 className="text-ligth-white font-bold text-xl p-4 bg-dark-purple rounded-t-lg">EDITAR MÍDIA</h2>
                    </div>

                    <form onSubmit={handleSubmit}>

                        <div className="m-12">
                            <label className="block text-black mb-2">Nome da Mídia:</label>
                            <input type="text" className="w-full px-3 py-2 border rounded-lg" value={title} onChange={e => setTitle(e.target.value)} required />
                        </div>
